...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%><!-- 해당 uri를 c라는 이름으로 사용할 것을 선언함 -->
<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Set1.jsp</title></head><body>
